...
activities = {
    ...
    "Track and Field": {
        "description": "Running, jumping, and throwing events for track competition",
        "schedule": "Tuesdays and Thursdays, 3:45 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["ryan@mergington.edu", "jessica@mergington.edu"]
    },
    "Art Studio": {
        "description": "Painting, drawing, and sculpture in a creative studio environment",
    ...
    "Music Band": {
        ...
        "max_participants": 20,
        "participants": ["alex@mergington.edu", "sophie@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Explore scientific experiments and attend STEM competitions",
